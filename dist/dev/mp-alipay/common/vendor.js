...
var SYNC_API_RE = /^\$|^report|interceptors|Interceptor$|getSubNVueById|requireNativePlugin|upx2px|hideKeyboard|canIUse|^create|Sync$|Manager$|base64ToArrayBuffer|arrayBufferToBase64/;
    ...
    return new Promise(function (resolve, reject) {
      uni.request({
        ...
        header: {
          ...
          'version': _store.default.state.user.version,
          'timeStamp': Date.now(),
            ...
            uni.showToast({
              ...
              success: function success() {
                uni.removeStorage({
                  ...
                  success: function success() {
                    // 清除vuex
                    _store.default.dispatch('user/saveToVuex', {
                      openId: null,
                      unionId: null,
                      sessionKey: null
                    });
...
var _home = _interopRequireDefault(__webpack_require__(/*! ./modules/home */ 11));

var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user */ 12));
...
var actions = {}; // 定义同步函数 Mutations 变化
...
var actions = {
  ...
  wxsmall: function wxsmall(_ref) {
    ...
    return new Promise(function (resolve, reject) {
      uni.login({
        ...
        success: function success(res) {
          if (res.code) {
            _httpclient.default.post('/newxcx/login/getWxOpenId', {
              code: res.code,
              appId: state.appId
            }).then(function (data) {
  ...
  // 无unionId 用户
  getUnionId: function getUnionId(_ref2) {
          ...
          if (res.authSetting['scope.userInfo']) {
            uni.getUserInfo({
              ...
              success: function success(infoRes) {
                _httpclient.default.post('/newxcx/encryptedData', {
  ...
  // 解密微信用户信息
  getWxUserInfo: function getWxUserInfo(_ref3, _ref4) {
    var commit = _ref3.commit,
        state = _ref3.state,
        dispatch = _ref3.dispatch;
    var sessionKey = _ref4.sessionKey;
    return new Promise(function (resolve, reject) {
      // 获取授权信息
      wx.getSetting({
        success: function success(res) {
  ...
  // 支付宝小程序换取授权访问令牌
  aliUserInfo: function aliUserInfo(_ref5, _ref6) {
    var commit = _ref5.commit,
        state = _ref5.state,
        dispatch = _ref5.dispatch;
    var code = _ref6.code;
    return new Promise(function (resolve, reject) {
      _httpclient.default.post('/newxcx/login/aliUserInfo', {
        code: code
      }).then(function (data) {
  ...
  // 保存微信信息
  saveWxUser: function saveWxUser(_ref7, json) {
  ...
  // 获取当前平台
  getProvider: function getProvider(_ref8, _ref9) {
...
var mutations = {
  setUserInfo: function setUserInfo(state, json) {
    state.userInfo = json;
  },
  setwxUser: function setwxUser(state, json) {
    state.wxUser = json;
  }
};
var getters = {};
